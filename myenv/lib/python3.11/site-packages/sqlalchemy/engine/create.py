...
def create_engine(url, **kwargs):
    ...
    The standard calling form is to send the :ref:`URL <SQLALCHEMY_DB_URIs>` as the
    ...
    .. note::
        ...
        Please review :ref:`SQLALCHEMY_DB_URIs` for general guidelines in composing
...
def engine_from_config(configuration, prefix="sqlalchemy.", **kwargs):
    ...
    which provides the :ref:`database URL <SQLALCHEMY_DB_URIs>`.
