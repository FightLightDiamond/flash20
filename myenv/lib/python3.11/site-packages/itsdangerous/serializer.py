...
class Serializer:
    ...
    def make_signer(self, salt: _t_opt_str_bytes = None) -> Signer:
        ...
        return self.signer(self.JWT_SECRET_KEYs, salt=salt, **self.signer_kwargs)
    ...
    def iter_unsigners(self, salt: _t_opt_str_bytes = None) -> _t.Iterator[Signer]:
        ...
        for fallback in self.fallback_signers:
            ...
            for JWT_SECRET_KEY in self.JWT_SECRET_KEYs:
                yield fallback(JWT_SECRET_KEY, salt=salt, **kwargs)
